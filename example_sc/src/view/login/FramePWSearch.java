...
public class FramePWSearch extends JPanel {
	...
	public FramePWSearch(JPanel homePanel) {
		...
		// 아이디찾기 버튼 이미지와 리스너 설정
				ImageIcon originalLoginIcon = new ImageIcon("./src/비밀번호찾기_비밀번호찾기.png");
				...
				ImageIcon originalLoginHoverIcon = new ImageIcon("./src/비밀번호찾기_비밀번호찾기hover.png");
				Image scaledLoginHoverImage = originalLoginHoverIcon.getImage().getScaledInstance(140, 40, Image.SCALE_SMOOTH); // 호버 이미지 크기 조정
				ImageIcon loginHoverIcon = new ImageIcon(scaledLoginHoverImage);

				// 이전 버튼 이미지와 리스너 설정
				ImageIcon originalIDSearchIcon = new ImageIcon("./src/아이디찾기_이전.png");
				...
				ImageIcon originalIDSearchHoverIcon = new ImageIcon("./src/아이디찾기_이전hover.png");
