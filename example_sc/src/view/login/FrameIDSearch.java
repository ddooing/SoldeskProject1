...
public class FrameIDSearch extends JPanel{
	...
	public FrameIDSearch(JPanel homePanel) {
		...
		lName.setLocation(getWidth() / 2 - 150, 100);
		...
		tfName.setLocation(getWidth() / 2 -110, 100);
		tfName.setFont(new Font("나눔스퀘어OTF Bold", Font.BOLD, 22));

		tfPhone.setSize(270, 50);
		tfPhone.setLocation(getWidth() / 2 -110, 170);
		...
		ImageIcon originalLoginIcon = new ImageIcon("./src/아이디찾기_아이디찾기.png");
		...
		ImageIcon originalLoginHoverIcon = new ImageIcon("./src/아이디찾기_아이디찾기hover.png");
