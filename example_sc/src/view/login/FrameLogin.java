...
public class FrameLogin extends JPanel {
	...
	public FrameLogin(JPanel homePanel) {
		...
		lPW.setSize(300, 50);
		lPW.setLocation(getWidth() / 2 - 163, 180);
		...
		tfPW.setSize(270, 50);
		tfPW.setLocation(getWidth() / 2 -120, 180);
		...
		// 로그인 버튼 이미지와 리스너 설정
		ImageIcon originalLoginIcon = new ImageIcon("./src/로그인_로그인.png");
		...
		ImageIcon originalLoginHoverIcon = new ImageIcon("./src/로그인_로그인hover.png");
		...
		ImageIcon originalIDSearchIcon = new ImageIcon("./src/아이디찾기.png");
		...
		ImageIcon originalIDSearchHoverIcon = new ImageIcon("./src/아이디찾기hover.png");
		...
		ImageIcon originalPWSearchIcon = new ImageIcon("./src/비밀번호찾기.png");
		...
		ImageIcon originalPWSearchHoverIcon = new ImageIcon("./src/비밀번호찾기hover.png");
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (idCheck.isEmpty()) {
					...
					if (idCheck.equals(new String(tfPW.getPassword()))) {
						...
						FrameBase.getInstance(new Home(frameLoginPanel));
						dispose();
					} else {
